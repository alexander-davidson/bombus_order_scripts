...
void loop() {
  pixels.fill(pixels.Color(0, 0, 0, intensity), 0, 7); // rgb, starting led, how many leds from starting led
  pixels.fill(pixels.Color(0, intensity, 0, 0), 7, 7);
  pixels.show();
  delay(col_duration_val);

  //pixels.fill(pixels.Color(0, intensity, 0, 0), 0, 7);
  //pixels.fill(pixels.Color(0, 0, 0, intensity), 7, 7);
  //pixels.show();
  //delay(col_duration_val);
